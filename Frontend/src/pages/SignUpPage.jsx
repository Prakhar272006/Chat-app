...
import { User ,Mail,Loader2,Lock,EyeOff,Eye,MessagesSquare } from "lucide-react";
...
const SignUpPage = () => {
  ...
  return (
    <div className="  min-h-screen flex justify-center items-center lg:grid-cols-2">
        ...
        <div className="w-full max-w-md space-y-8">
          <div className="text-center  mb-8">
            ...
            <p className="text-base-content/60">
              get started with our free account
            </p>
          </div>
        </div>
